...
namespace ClarionDctAddin
{
    ...
    internal class GlobalSearchDialog : Form
    {
        ...
        void BuildUi()
        {
            ...
            chkRegex  = new CheckBox { Text = "Regex", Left = 630, Top = 8, AutoSize = true, Font = new Font("Segoe UI", 9F) };
            ...
            chkTables       = MakeCheck("Tables",         0,  true);
            chkFields       = MakeCheck("Fields",         90, true);
            chkKeys         = MakeCheck("Keys",          180, true);
            chkRelations    = MakeCheck("Relations",     260, true);
            chkTriggers     = MakeCheck("Triggers",      360, true);
            chkDescriptions = MakeCheck("Descriptions",  450, true);
